...
**
**    Parameter       Cmd   Standard       --big      --huge  --wolfgang (old)
**    ------------------------------------------------------------------
